setwd("E:\\spatial-causality\\R\\GCCM_updated\\Cases\\raster\\Heavymetal")
...
{
  xName<-Envs[e]
  xVariable<-EnviImages[[e]]
  xMatrix<-as.matrix(xVariable)
  
  x_xmap_y <- GCCM(xMatrix, yMatrix, lib_sizes, lib, pred, E,tau = 1,b=E+2,winStepRatio = 0,cores=16,dir=0)
  y_xmap_x <- GCCM(yMatrix, xMatrix, lib_sizes, lib, pred, E,tau = 1,b=E+2,winStepRatio = 0,cores=16,dir=0)
