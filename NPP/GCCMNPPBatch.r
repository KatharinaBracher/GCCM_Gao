...
#####################npp#################
#npp<-readGDAL("F:/data/npp/average/npp10km.tif")
...
#{
#  fileName<-paste("F:/data/npp/average/",climates[e],".tif",sep = "")
#  climateImages[[e]]<-as.matrix(readGDAL(fileName))
#}

#save(nppImage,climateImages,file="npp.RData")
